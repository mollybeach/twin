...
export namespace $default {
  ...
  export interface Analytics extends std.$Object {
...
export type Demographics = $default.Demographics;
export type FetchedTweet = $default.FetchedTweet;
export type Notification = $default.Notification;
export type NotificationType = $default.NotificationType;
export type PeakHours = $default.PeakHours;
export type ReachByPlatform = $default.ReachByPlatform;
export type TokenShare = $default.TokenShare;
export type TokenStats = $default.TokenStats;
export type TopInteractions = $default.TopInteractions;
export type Transaction = $default.Transaction;
export type TransactionType = $default.TransactionType;
export type Twineet = $default.Twineet;
export type UserTokenShare = $default.UserTokenShare;
export type Verification = $default.Verification;
...
export interface types {
  ...
  "default": {
    ...
    "Demographics": $default.Demographics;
    "FetchedTweet": $default.FetchedTweet;
    "Notification": $default.Notification;
    "NotificationType": $default.NotificationType;
    "PeakHours": $default.PeakHours;
    "ReachByPlatform": $default.ReachByPlatform;
    "TokenShare": $default.TokenShare;
    "TokenStats": $default.TokenStats;
    "TopInteractions": $default.TopInteractions;
    "Transaction": $default.Transaction;
    "TransactionType": $default.TransactionType;
    "Twineet": $default.Twineet;
    "UserTokenShare": $default.UserTokenShare;
